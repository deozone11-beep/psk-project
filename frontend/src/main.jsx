...
createRoot(document.getElementById('root')).render(window.location.pathname.startsWith('/report')||window.location.pathname.startsWith('/census/public')?<CensusPublicSupervisorReport/>:window.location.pathname.startsWith('/census')?<CensusStandalonePage/>:window.location.pathname.startsWith('/admin')?<AdminApp/>:window.location.pathname.startsWith('/portal')?<CustomerApp/>:window.location.pathname.startsWith('/login')?<LoginPage/>:window.location.pathname.startsWith('/leadership')?<LeadershipPage/>:window.location.pathname.startsWith('/projects')?<ProjectsPage/>:window.location.pathname.startsWith('/reviews')||window.location.pathname.startsWith('/testimonials')?<ReviewsPage/>:<App/>);
